...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'aura')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'aura')
@Component({
